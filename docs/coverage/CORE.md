...
| --- | --- | --- | --- | --- | --- | --- | --- |
| screenpipe-engine | 10 | 18 | 98 | 1356 | 42 | 1044.2 | 10 |
...
| database | 6 suites / 322 active / 12 ignored / 303.2 pts | 6 suites / 322 active / 12 ignored / 303.2 pts | 6 suites / 322 active / 12 ignored / 303.2 pts |
...
| meeting | 6 suites / 1287 active / 15 ignored / 1049.4 pts | 6 suites / 1287 active / 15 ignored / 1049.4 pts | 4 suites / 1016 active / 12 ignored / 798.8 pts |
...
| pipes | 1 suites / 434 active / 3 ignored / 303.8 pts | 1 suites / 434 active / 3 ignored / 303.8 pts | 1 suites / 434 active / 3 ignored / 303.8 pts |
| privacy | 5 suites / 841 active / 36 ignored / 686.2 pts | 5 suites / 888 active / 16 ignored / 690.6 pts | 5 suites / 817 active / 14 ignored / 664.4 pts |
...
| sync | 1 suites / 434 active / 3 ignored / 303.8 pts | 1 suites / 434 active / 3 ignored / 303.8 pts | 1 suites / 434 active / 3 ignored / 303.8 pts |
...
| ui-events | 4 suites / 669 active / 28 ignored / 512.2 pts | 3 suites / 621 active / 5 ignored / 478.6 pts | 3 suites / 621 active / 5 ignored / 478.6 pts |
...
| engine-meeting-privacy-sync | screenpipe-engine | windows, macos, linux | meeting, privacy, ui-events, pipes, sync | meeting-live-notes, privacy-and-redaction, accessibility-ui-events, performance-liveness | medium | strong | unit | 29 | 434 | 3 | Unit-heavy coverage for privacy filter policy, capture exclusions, UI recorder safety, pipes/live-view/structured-output helpers, sync helpers, and CLI parsing. Meeting detection moved to the engine-meeting-watcher suite. |
...
| a11y-macos-tree | screenpipe-a11y | src/platform/macos.rs | source | 16 | 0 | 16 |
...
| a11y-core-tree-cross-platform | screenpipe-a11y | src/url_filter.rs | source | 8 | 0 | 8 |
...
| audio-device-stream-health | screenpipe-audio | src/audio_manager/manager.rs | source | 16 | 1 | 17 |
| audio-meetings-speakers-dedup | screenpipe-audio | src/audio_manager/meeting_piggyback.rs | source | 40 | 0 | 40 |
| audio-meetings-speakers-dedup | screenpipe-audio | src/audio_manager/piggyback_listeners.rs | source | 2 | 0 | 2 |
| audio-meetings-speakers-dedup | screenpipe-audio | src/audio_manager/reconciliation.rs | source | 21 | 1 | 22 |
| audio-platform-output-capture | screenpipe-audio | src/audio_manager/windows_output_follow.rs | source | 15 | 0 | 15 |
| audio-device-stream-health | screenpipe-audio | src/core/device_detection.rs | source | 13 | 0 | 13 |
| audio-device-stream-health | screenpipe-audio | src/core/device.rs | source | 17 | 1 | 18 |
...
| audio-platform-output-capture | screenpipe-audio | src/core/meeting_audio/macos.rs | source | 4 | 0 | 4 |
...
| audio-platform-output-capture | screenpipe-audio | src/core/process_tap/macos.rs | source | 23 | 0 | 23 |
...
| audio-device-stream-health | screenpipe-audio | src/device/device_manager.rs | source | 5 | 0 | 5 |
...
| audio-meetings-speakers-dedup | screenpipe-audio | src/meeting_processes.rs | source | 11 | 1 | 12 |
| audio-meetings-speakers-dedup | screenpipe-audio | src/meeting_streaming/config.rs | source | 12 | 0 | 12 |
| audio-meetings-speakers-dedup | screenpipe-audio | src/meeting_streaming/controller.rs | source | 13 | 0 | 13 |
...
| db-audio-meetings-speakers | screenpipe-db | tests/speaker_reassignment_test.rs | integration | 16 | 0 | 16 |
...
| db-audio-meetings-speakers | screenpipe-db | tests/timeline_live_meeting_test.rs | integration | 11 | 0 | 11 |
...
| engine-meeting-privacy-sync | screenpipe-engine | src/cli/team.rs | source | 11 | 0 | 11 |
...
| engine-meeting-privacy-sync | screenpipe-engine | src/connections_api.rs | source | 83 | 0 | 83 |
| engine-telemetry-observability | screenpipe-engine | src/crash_log.rs | source | 4 | 0 | 4 |
| engine-retention-storage | screenpipe-engine | src/disk_pressure.rs | source | 9 | 0 | 9 |
| engine-meeting-privacy-sync | screenpipe-engine | src/drm_detector.rs | source | 19 | 2 | 21 |
| engine-capture-timeline | screenpipe-engine | src/event_driven_capture.rs | source | 76 | 0 | 76 |
...
| engine-meeting-privacy-sync | screenpipe-engine | src/mcp_servers_api.rs | source | 16 | 0 | 16 |
...
| engine-meeting-privacy-sync | screenpipe-engine | src/qualified_value.rs | source | 2 | 0 | 2 |
...
| engine-retention-storage | screenpipe-engine | src/retention.rs | source | 8 | 0 | 8 |
...
| engine-api-routes | screenpipe-engine | src/routes/frames.rs | source | 5 | 1 | 6 |
| engine-api-routes | screenpipe-engine | src/routes/health.rs | source | 27 | 0 | 27 |
| engine-api-routes | screenpipe-engine | src/routes/live_views.rs | source | 1 | 0 | 1 |
| engine-api-routes | screenpipe-engine | src/routes/meetings.rs | source | 4 | 0 | 4 |
...
| engine-capture-timeline | screenpipe-engine | src/vision_manager/manager.rs | source | 9 | 0 | 9 |
| engine-capture-timeline | screenpipe-engine | src/vision_manager/monitor_watcher.rs | source | 15 | 0 | 15 |
...
| engine-local-api-search-integration | screenpipe-engine | tests/endpoint_test.rs | integration | 4 | 5 | 9 |
...
| engine-capture-timeline | screenpipe-engine | tests/stream_frames_test.rs | integration | 1 | 5 | 6 |
...
| screen-capture-windowing | screenpipe-screen | src/metrics.rs | source | 9 | 0 | 9 |
...
| screen-monitor-platform | screenpipe-screen | src/monitor/macos.rs | source | 5 | 2 | 7 |
